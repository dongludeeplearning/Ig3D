...
def run_training():
    ...
    model = EmocaEarlyLinearFUsion(num_class=args.num_class, num_head=args.num_head)
    model.to(device)
        ...
        with torch.no_grad():
            ...
            if acc > best_acc:
                ...
                torch.save({'iter': epoch,
                           ...
                           os.path.join('checkpoints', "affecnet_Emoca_156_features_early_linear_fusion_epoch"+str(epoch)+"_acc"+str(acc)+".pth"))
