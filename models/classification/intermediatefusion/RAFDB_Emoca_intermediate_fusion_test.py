...
def parse_args():
    ...
    parser.add_argument('--featured_model_path', default = 'final_checkpoint/RAFDB_Emoca_334_features_early_linear_fusion_epoch25_acc0.9012.pth')
...
def run_test():
    ...
    model_emoca = RAFDB_EmocaEarlyLinearFUsion(num_class=args.num_class, num_head=args.num_head)
    ...
    plt.savefig(os.path.join('FusionConfusionMatrix', f"RAFDB_Emoca_Early_fusion_acc{acc}.png"))
    plt.close()
