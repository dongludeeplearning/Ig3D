...
def run_training():
    ...
    model = RAFDB_SmirkEarlyLinearFUsion(num_class=args.num_class, num_head=args.num_head)
    model.to(device)
        ...
        with torch.no_grad():
            ...
            if acc > best_acc:
                ...
                torch.save({'iter': epoch,
                           ...
                           os.path.join('checkpoints', "RAFDB_SMirk_358_features_early_linear_fusion_epoch"+str(epoch)+"_acc"+str(acc)+".pth"))
