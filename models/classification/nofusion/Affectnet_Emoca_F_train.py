...
from networks.SER import EmocaEmoRecognition_F 
        ...
        with torch.no_grad():
            ...
            if acc > best_acc:
                ...
                torch.save({'iter': epoch,
                           ...
                           os.path.join('final_checkpoint', "Affecnet_Emoca_F_epoch"+str(epoch)+"_acc"+str(acc)+".pth"))
