...
def parse_args():
    ...
    parser.add_argument('--aff_path', type=str, default='/home/hbml-user/XiaoWang/FaceData/RAF-DBAndSmirk/DATASET', help='RAF smirk dataset path.')
    parser.add_argument('--batch_size', type=int, default=32, help='Batch size.')
    parser.add_argument('--workers', default=0, type=int, help='Number of data loading workers.')
    parser.add_argument('--epochs', type=int, default=200, help='Total training epochs.') # 40->10
...
def run_training():
    ...
    model = SmirkRecognition(input_size = args.input_dim)
    model.to(device)
    ...
    best_acc = 0
    log_file_path = "RAFDB__smirk_full_feature_simple.log"
            ...
            with torch.no_grad():
                ...
                if acc > best_acc:
                    ...
                    torch.save({'iter': epoch,
                               ...
                               os.path.join('final_checkpoint', "RAFDB_smirk353_epoch" + str(epoch) + "_acc" + str(acc) + ".pth"))
